...
public class NewBookingController implements Initializable {
    ...
    @FXML
    private Label earlyCheckIn;
    @FXML
    private Label lateCheckOut;
    @FXML
    ...
    private void generateTable() throws ParseException {
    ...
    private void addentry(ActionEvent event) throws ParseException, SQLException {
        ...
        if (gueststextfield.getText().equals("")) {
            ...
            reference = Character.toString(checkInTime.getValue().toString().charAt(0)) + date;
            System.out.println("refernece is: " + reference);
    ...
    @FXML
    private void showBreakfast(ActionEvent event) throws ParseException {
...
ps.bookings(event);
    ...
    private void addDummyData(ActionEvent event) {
       ...
       String query = "INSERT INTO APP.BOOKING "
                ...
                + "CHECKOUT,"
                + "CHECKINTIME,"
                + "CHECKOUTTIME , REMAINING)"
                + "VALUES"
                + "('M20150505','TEST', 2, 3, '2015-05-05', '2015-05-24', 'MORNING', 'AFTERNOON', 50)";
        ...
        String query2 = "INSERT INTO APP.BOOKING_AVAILABILITIES "
                + "(ROOM, "
                + " DATE_BOOKED,"
                + "BREAKFAST, REFERENCECODE) VALUES"
    ...
    /**
    public Stage useDateFilter(LocalDate AD, LocalDate DD) {
        FXML loader = (FXML) new FXMLLoader(getClass().getResource("ViewRoomsController.fxml"));
        
        Stage stage = new Stage(StageStyle.DECORATED);
        stage.setScene(new Scene((Pane) loader.load()));
        
        ViewRoomsController controller = loader.<ViewRoomsController>getController();
...
// Add to the data any time, and the table will be updated
            ...
            java.sql.Statement statement = conn.createStatement();
            ResultSet viewBookings = statement.executeQuery("SELECT * FROM APP.BOOKING_AVAILABILITIES");

            System.out.println("query created");

            while (viewBookings.next()) {
                System.out.println("Data from database: " + viewBookings.getString(1) + " " + viewBookings.getString(2) + " " + viewBookings.getString(3));;
