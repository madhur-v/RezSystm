 ...
 * @author yuling
 */
        class PairKeyFactoryEditBooking implements Callback<TableColumn.CellDataFeatures<Pair<String, Object>, String>, ObservableValue<String>> {
    @Override
...
class PairValueFactoryEditBooking implements Callback<TableColumn.CellDataFeatures<Pair<String, Object>, Object>, ObservableValue<Object>> {
...
class PairValueCellEditBooking extends TableCell<Pair<String, Object>, Object> {
    @Override
    protected void updateItem(Object item, boolean empty) {
        ...
        if (item != null) {
            ...
            public void handle(ActionEvent t) {
                // get Selected Item
                Pair pear = (Pair) PairValueCellEditBooking.this.getTableView().getItems().get(PairValueCellEditBooking.this.getIndex());
...
//+ pear.getDate() +
               ...
               // NewBookingController.addBreakfast(currentBreakfast.getDate(), checkbox.isSelected());
                ...
                EditBookingController.addBreakfast(date, checkBox.isSelected());              
